...
namespace GoSiming\DcatDistpicker\Form;
...
class Distpicker extends Field
{
    ...
    public function render()
    {
        ...
        $province = old($this->column['province'], Arr::get($this->value(), 'province')) ?: Arr::get(
            $this->placeholder,
            'province'
        );
        $city = "";
        ...
        if (isset($this->column['city'])) {
            $city = old($this->column['city'], Arr::get($this->value(), 'city')) ?: Arr::get(
                $this->placeholder,
                'city'
            );
        }
        if (isset($this->column['district'])) {
            $district = old(
                ...
                Arr::get($this->value(), 'district')
            ) ?: Arr::get($this->placeholder, 'district');
        }
